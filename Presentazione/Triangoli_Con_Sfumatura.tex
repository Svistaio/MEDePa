...
% Per la classe «beamer» l'origine «tikzpicture» è nell'angolo in alto a sinistra contrariamente alla classe «article» in cui si trova in basso a sinistra

\newcommand{\scala}{2.5}

% Per la convesione di punti in centimetri bisogna o moltiplicare per 0.3515 il numero di punti oppure, equivalentemente, dividere per 28.4495 (si v. https://www.overleaf.com/learn/latex/Lengths_in_LaTeX e https://en.wikibooks.org/wiki/LaTeX/Lengths)
...
\usebackgroundtemplate{
    \begin{tikzpicture}[remember picture,overlay,scale=\scala]
        ...
        {
            \pgfmathsetmacro{\ABRx}{-(\yB-\yA)}
            \pgfmathsetmacro{\ABRy}{\xB-\xA}
            \pgfmathsetmacro{\normaABR}{sqrt((\yB-\yA)^2+(\xB-\xA)^2)}
            \pgfmathsetmacro{\dx}{(\ABRx*\sL/2)/\normaABR}
            \pgfmathsetmacro{\dy}{(\ABRy*\sL/2)/\normaABR}
            
            \ifnum\iL=0
                \begin{pgfonlayer}{sfondo}
                    % \begin{scope}[shift={(0cm,0cm)},rotate=-90,clip]
                    %     \path[clip]
                    %     (\xA+\dx,\yA+\dy) --
                    %     (\xA-\dx,\yA-\dy) --
                    %     (\xB-\dx,\yB-\dy) --
                    %     (\xB+\dx,\yB+\dy) --
                    %     cycle;
                    %     \shade[inner color=black,outer color=white]
                    %           (0,0) circle (\rC);
                    % \end{scope}
                    \begin{scope}[shift={(\lP,0cm)},rotate=-180]
                        \path[clip]
                        (\xA+\dx,\yA+\dy) --
                        (\xA-\dx,\yA-\dy) --
                        (\xB-\dx,\yB-\dy) --
                        ...
                        \shade[inner color=black,outer color=white]
                              (0,0) circle (\rC);
                    \end{scope}
                    \begin{scope}[shift={(\lP,-\aP)},rotate=90]
                        \path[clip]
                        (\xA+\dx,\yA+\dy) --
                        (\xA-\dx,\yA-\dy) --
                        (\xB-\dx,\yB-\dy) --
                        ...
                        \shade[inner color=black,outer color=white]
                              (0,0) circle (\rC);
                    \end{scope}
                    \begin{scope}[shift={(0cm,-\aP)},rotate=0]
                        \path[clip]
                        (\xA+\dx,\yA+\dy) --
                        (\xA-\dx,\yA-\dy) --
                        (\xB-\dx,\yB-\dy) --
            ...
            \ifnum\iL=1
                \begin{pgfonlayer}{primopiano}
                    % \begin{scope}[shift={(0cm,0cm)},rotate=-90]
                    %     \path[clip]
                    %     (\xA+\dx,\yA+\dy) --
                    %     (\xA-\dx,\yA-\dy) --
                    %     (\xB-\dx,\yB-\dy) --
                    %     (\xB+\dx,\yB+\dy) --
                    %     cycle;
                    %     \shade[inner color=\cEE,outer color=white]
                    %           (0,0) circle (\rC);
                    % \end{scope}
                    \begin{scope}[shift={(\lP,0cm)},rotate=-180]
                        \path[clip]
            ...
            \ifnum\iL=-1
                \begin{pgfonlayer}{primopiano}
                    ...
                    %     (\xB+\dx,\yB+\dy) --
                    %     cycle;
                    %     \shade[inner color=\cEI,outer color=white]
                    %           (0,0) circle (\rC);
                    % \end{scope}
                    \begin{scope}[shift={(\lP,0cm)},rotate=-180]
                        \path[clip]
